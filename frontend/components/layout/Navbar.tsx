...
import {ChevronDown, LogOut, Plus, User, Wallet} from 'lucide-react';
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex-shrink-0">
                        <div className="flex items-center">
                            ...
                            <span className="ml-2 text-xl font-bold text-white">Xnfty</span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="relative">
                            ...
                            >
                                <div
                                    className="w-6 h-6 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
                  ...
                  {walletAddress ? formatAddress(walletAddress) : 'Profile'}
                            ...
                            {showProfileMenu && (
                                <div
                                    className="absolute right-0 top-full mt-1 w-64 bg-gray-800 border border-gray-700 rounded-lg shadow-xl z-50">
