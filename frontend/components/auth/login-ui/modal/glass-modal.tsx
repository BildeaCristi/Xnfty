...
export default function GlassModal({children}: GlassModalProps) {
    ...
    return (
        ...
        >
            ...
            <div className="mt-8 text-center text-md text-black-100/60">
                <p>Connect your wallet or sign in with Google to start exploring the future of digital ownership</p>
            </div>
