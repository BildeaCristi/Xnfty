...
import { ArrowLeft, Share2, Users, Coins, ExternalLink, Image, Calendar, User as UserIcon, Copy, Check } from 'lucide-react';
...
export default function CollectionDetailContent({ collectionId, session }: CollectionDetailContentProps) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-start justify-between mb-4">
                ...
                {isOwner && (
                  <span className="bg-blue-600 text-white text-xs sm:text-sm px-2 sm:px-3 py-1 rounded-full ml-2 flex-shrink-0">
                    Your Collection
                  </span>
                )}
              </div>
              ...
              <div className="mb-6 p-4 bg-gray-800/50 rounded-lg border border-gray-600">
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    ...
                    <a
                      href={`https://etherscan.io/address/${collection.collectionAddress}`}
                      target="_blank"
                  ...
                  <div className="p-3 sm:p-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {nft.isfractionalized && (
                        <div className="flex items-center space-x-1 bg-purple-600/20 text-purple-300 px-2 py-1 rounded-full text-xs">
