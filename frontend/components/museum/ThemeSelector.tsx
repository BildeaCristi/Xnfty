...
export default function ThemeSelector() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="bg-gray-900/95 backdrop-blur-xl rounded-2xl p-8 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto border border-gray-700/50 shadow-2xl">
        {/* Header */}
        ...
        <div className="mt-6 p-4 bg-gray-800/50 rounded-lg">
          <p className="text-sm text-gray-400 text-center">
            You can change these settings anytime by pressing <kbd className="px-2 py-1 bg-gray-700 rounded text-xs">ESC</kbd> in the museum
          </p>
        </div>
      </div>
    </div>
