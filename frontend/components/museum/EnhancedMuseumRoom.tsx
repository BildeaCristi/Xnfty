  ...
  const floorMaterial = useMemo(() => {
    ...
    switch (themeName) {
      ...
      case 'futuristic':
        ...
        baseProps.emissiveIntensity = 0.1;
        break;
      case 'nature':
  ...
  const ceilingMaterial = useMemo(() => {
    ...
    switch (themeName) {
      case 'futuristic':
        ...
        baseProps.emissiveIntensity = 0.05;
        break;
      case 'modern':
        ...
        <>
          ...
          <group>
            ...
            <mesh position={[0, height - 0.15, -depth / 2 + 0.05]} castShadow={shadowsEnabled}>
              ...
              <meshStandardMaterial 
                color="#f0f0f0" 
                roughness={themeName === 'futuristic' ? 0.2 : 0.7}
                metalness={themeName === 'futuristic' ? 0.8 : 0.1}
                emissive={themeName === 'futuristic' ? new THREE.Color('#001144') : new THREE.Color('#000000')}
                emissiveIntensity={themeName === 'futuristic' ? 0.1 : 0}
              />
            </mesh>
            {/* Back crown */}
            <mesh position={[0, height - 0.15, depth / 2 - 0.05]} castShadow={shadowsEnabled}>
