...
import { getCollectionNFTs } from './BlockchainService';

/**
 * SearchComponent through collections and their NFTs
 */
export class SearchEngine {
  ...
  /**
   * SearchComponent collections by name or description
   */
  ...
  /**
   * SearchComponent NFTs across all collections
   */
  private async searchNFTs(query: string): Promise<SearchResult[]> {
    ...
    // SearchComponent through all collections
